...
INSERT INTO `t_bbs` VALUES ('8', null, '按时打算', '1', '阿瑟大声道v24534', '阿瑟大声道v24534', '3', '20', null, '2014-09-10 22:01:23', '2014-09-10 22:40:32', null, null, null, null, '6', '0');
...
INSERT INTO `t_bbs` VALUES ('20', null, null, '1', 'afasdfasdf', 'afasdfasdf', null, '10', null, '2014-09-21 12:36:00', null, null, null, null, '23', '0', '0');
INSERT INTO `t_bbs` VALUES ('21', null, null, '1', 'afasdfasdf', 'afasdfasdf', null, '10', null, '2014-09-21 12:37:36', null, null, null, null, '23', '0', '0');
INSERT INTO `t_bbs` VALUES ('22', null, null, '1', 'wochao', 'wochao&amp;nbsp;', null, '10', null, '2014-09-21 12:38:00', null, null, null, null, '23', '0', '0');
INSERT INTO `t_bbs` VALUES ('23', '', 'asdfasdfaa', '23', 'sfsdfsd', 'sfsdfsd', '1', '10', null, '2014-09-21 12:59:43', '2014-09-21 12:59:43', null, null, null, null, '2', '0');
INSERT INTO `t_bbs` VALUES ('24', null, null, '1', '&lt;img src=&quot;/eds/trunk/Public/kindeditor-4.1.10/attached/image/20140929/20140929143220_31818.jpg&quot; alt=', '&lt;div style=&quot;text-align:center;&quot;&gt;\n	&lt;img src=&quot;/eds/trunk/Public/kindeditor-4.1.10/attached/image/20140929/20140929143220_31818.jpg&quot; alt=&quot;&quot; /&gt;\n&lt;/div&gt;', null, '10', null, '2014-09-29 20:32:24', null, null, null, null, '1', '0', '0');
INSERT INTO `t_bbs` VALUES ('25', null, null, '1', '来个分隔符', '来个分隔符', null, '10', null, '2014-09-29 20:34:29', null, null, null, null, '23', '0', '0');
...
CREATE TABLE `t_event` (
  ...
  `vkey` varchar(128) DEFAULT NULL COMMENT '将此事件置为已查看的密码',
  PRIMARY KEY (`vid`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;
...
-- Records of t_event
-- ----------------------------
INSERT INTO `t_event` VALUES ('1', '1', '这里是标题', null, '1', '/Home/Bbs/post_dtl?tid=1#start', '2014-09-07 12:03:24', '10', '1', 'eqqweqewe');
INSERT INTO `t_event` VALUES ('2', '1', '试试看', null, '1', '2014-09-21 12:37:36', '0000-00-00 00:00:00', '10', '1', 'eafcasdfsalkfhskd');
INSERT INTO `t_event` VALUES ('3', '1', '试试看', null, '1', '2014-09-21 12:38:00', '0000-00-00 00:00:00', '10', '1', 'sdcasdjsd');
INSERT INTO `t_event` VALUES ('4', '1', '太阳系边界现神秘“彩带” 粒子被困环形区域', null, '1', '/Home/Bbs/post_dtl?tid=1#start', '2014-09-29 20:32:24', '0', '1', '34twerrw4re');
INSERT INTO `t_event` VALUES ('5', '23', 'asdfasdfaa', null, '1', '/Home/Bbs/post_dtl?tid=23#start', '2014-09-29 20:34:29', '0', '1', 'fsdfre4es');
...
-- ----------------------------
INSERT INTO `t_register` VALUES ('1', 'system', '10470c3b4b1fed12c3baac014be15fac67c6e815', '系统管理员', '/assets/image/headphoto/default.png', '0', '0', '0', null, null, null, '2014-08-31 19:34:13', '2014-08-31 19:34:13', null);
INSERT INTO `t_register` VALUES ('20', 's123456', '1f604490cbdd4ec35cfa681bcf3df8fac26e0cb5', 'nick', '/assets/image/headphoto/default.png', '0', '0', '20', null, null, null, '2014-08-31 21:14:30', '2014-08-31 20:11:06', null);
...
INSERT INTO `t_register` VALUES ('37', 'TA201409131654548358', '1f604490cbdd4ec35cfa681bcf3df8fac26e0cb5', '姓名', '/assets/image/headphoto/default.png', '0', '0', '35', null, null, null, '2014-09-13 16:54:54', '2014-09-13 16:54:54', null);
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `t_register_manager_view` AS select `t_register`.`rid` AS `rid`,`t_register`.`raccount` AS `raccount`,`t_register`.`rpassword` AS `rpassword`,`t_register`.`rnickname` AS `rnickname`,`t_register`.`rhead_photo` AS `rhead_photo`,`t_register`.`rlast_lgid` AS `rlast_lgid`,`t_register`.`rstate` AS `rstate`,`t_register`.`rrole` AS `rrole`,`t_register`.`rshield_role` AS `rshield_role`,`t_register`.`rshielded_time` AS `rshielded_time`,`t_register`.`rshielded_type` AS `rshielded_type`,`t_register`.`rlast_edited_time` AS `rlast_edited_time`,`t_register`.`rcreated_time` AS `rcreated_time`,`t_register`.`rshielded_tick` AS `rshielded_tick`,`t_manager`.`mid` AS `mid`,`t_manager`.`mrid` AS `mrid`,`t_manager`.`mpcreate_teacher` AS `mpcreate_teacher`,`t_manager`.`mpcreate_news` AS `mpcreate_news`,`t_manager`.`mpcreate_act` AS `mpcreate_act`,`t_manager`.`mpcreate_plan_project` AS `mpcreate_plan_project`,`t_manager`.`mpedit_league_college` AS `mpedit_league_college`,`t_manager`.`mpcreate_notice` AS `mpcreate_notice`,`t_manager`.`mpcheck_ex_note` AS `mpcheck_ex_note`,`t_manager`.`mpcreate_ex_trend` AS `mpcreate_ex_trend`,`t_manager`.`mpcreate_ex_project` AS `mpcreate_ex_project`,`t_manager`.`mpcheck_courseware` AS `mpcheck_courseware`,`t_manager`.`mpcreate_topic` AS `mpcreate_topic`,`t_manager`.`mpcreate_post` AS `mpcreate_post`,`t_manager`.`mpcreate_reply` AS `mpcreate_reply`,`t_manager`.`mpcreate_msg` AS `mpcreate_msg`,`t_manager`.`mpmanager_user` AS `mpmanager_user`,`t_manager`.`mpmanager_bbs` AS `mpmanager_bbs` from (`t_register` join `t_manager`) where (`t_register`.`rid` = `t_manager`.`mrid`) ;
